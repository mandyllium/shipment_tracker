...
Test title
    ...
    Wait Until Element Is Visible  //div[@class='highlight-last-activity']  timeout=60s
    ${status}=   Get Text    xpath=//div[@class='highlight-last-activity']
    ${booking_history}=  Get Text    xpath=//div[@id='contentarea_tracking']//div[3]
