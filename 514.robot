...
Test title
    ...
    Wait Until Element Is Visible  //table[@id="tblstatus"]//tr  timeout=30s
    ${ROWS}=  Get Element Count    //table[@id="tblstatus"]//tr
    ${status}=   Get Text    xpath=//table[@id="tblstatus"]//tr[${ROWS}]//td[2]
    ${current_remarks}=  Get Text    xpath=//table[@id="tblstatus"]//tr[${ROWS}]
