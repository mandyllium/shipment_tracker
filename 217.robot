...
Get Current Remarks
    ...
    \  ${catenate} =   Get Text    xpath=//tr[@name='trackShiptable1rowInner0']//tr[1]//td[${COUNTER}]
...
Test title
    ...
    Wait Until Element Is Visible  //tr[@name='trackShiptable1rowInner0']  timeout=30s
    ${status}=   Get Text    xpath=//tr[@name='trackShiptable1rowInner0']//tr[1]//td[3]
    ${current_remarks}=  Get Current Remarks
    ${status_string}=    Get Text    xpath=//tr[@name='trackShiptable1rowInner0']
