...
Get Current Remarks
    ...
    \  ${catenate} =   Get Text    xpath=//tr[@id='ContentPlaceHolder1_rpFreightStatus_trRow_0']//td[${COUNTER}]
...
Test title
    ...
    Sleep    15s
    ${status}=   Get Text    xpath=//tr[@id='ContentPlaceHolder1_rpFreightStatus_trRow_0']//td[1]
