...
Test title
    ...
    Wait Until Element Is Visible  //tr[@class='line d1']//td[3]  timeout=30s
    ${status}=   Get Text    xpath=//tr[@class='line d1']//td[3]
    ${current_remarks}=  Get Text  xpath=//table[@class='details']//tr[2]//td[1]
